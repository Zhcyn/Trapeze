...
//                facebookBtn.run(scaleIn)
    ...
    func share(){
        let message = "Download Little Trapeze from the AppStore itms "
        
        if let link = NSURL(string: "itms-apps://itunes.apple.com/app/id1514037365")
        {
    ...
    func rateApp(){
        if #available(iOS 10.0, *) {
            UIApplication.shared.open(URL(string : "itms-apps://itunes.apple.com/app/id1514037365")!, options: [:]) { (done) in
                // Handle results
    ...
    func mail(){
        ...
        if MFMailComposeViewController.canSendMail() {
            ...
            mail.setSubject("Little Trapeze Feedback")
    ...
    func fb(){
        ...
        if SLComposeViewController.isAvailable(forServiceType: SLServiceTypeFacebook) {
            ...
            fb.setInitialText("Hey! Just scored \(GameManager.instance.getHighscore()) on Little Trapeze !  Try baet this!                            download From Here! https//itunes.apple.com/app/id1514037365 ")
    ...
    func twitter(){
        ...
        if SLComposeViewController.isAvailable(forServiceType: SLServiceTypeTwitter) {
            ...
            twitter.setInitialText("Hey! Just scored \(GameManager.instance.getHighscore()) on Little Trapeze !  Try baet this!                            download From Here! https//itunes.apple.com/app/id1514037365 ")
