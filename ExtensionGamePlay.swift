...
extension GamePlayScene {
    func createBar(){
        ...
        let barRight = SKSpriteNode(imageNamed: "GreenLazer") 
        let barLeft = SKSpriteNode(imageNamed: "BlueLazer") 
        barRight.name = "Bar"
        barRight.anchorPoint = CGPoint(x: 0.5, y: 0.5)
        barRight.position = CGPoint(x: 550 , y: 0) 
        ...
        barLeft.position = CGPoint(x: -550 , y: 0) 
